...
%%%%%%%%%%%%%%%%%%%%%%%%                                               %%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for iN = 1:length(idx)
        Adum = zeros(round(R),round(C));          % Dummy 2D matrix containing weighting at each cell
        Adum(idx(iN)) = 2;          % set current entry to a value of 2
        [iR, iC]=find(Adum==2);     % find locations of the entry identified on above row
    ...
    %%%%%%%%%%%%%%%%%%_corners of model_%%%%%%%%%%%%%%%%%%%%
            ...
            elseif iR == 10 && iC == 1      %top left of model - exposed to air 
                cas = 2;
                Adum(iR,iC:iC+1) = [-(1 + Bi) .5];
                Adum(iR-1,iC) = .5;
                b(iN) = -Bi*T_air
            ...
            elseif iR == 10 && iC == 17      %top right of model
                cas = 3;
                Adum(iR,iC-1:iC) = [.5 -(1 + Bi)];
                Adum(iR-1,iC) = .5;
                b(iN) = -Bi*T_air;
            ...
            elseif iR == 1 && iC == 17      %bottom right of model
                cas = 4;
                Adum(iR,iC-1:iC) = [1 -2];
                Adum(iR+1,iC)    = 1;
    ...
    %                      right and left side                        %
            ...
            elseif iR == 10 && iC == 17      %right side insulation meets tile
                cas = 6;
                Adum(iR,iC-1:iC) = [k_t -(2*k_t+k_i)];
                Adum(iR+1,iC)    = k_t;
                Adum(iR-1,iC)    = k_i;
            ...
            elseif iR == 10 && iC == 1      %right side insulation meets tile
                cas = 6;
                Adum(iR,iC:iC+1) = [-(2*k_t+k_i) k_t];
                Adum(iR+1,iC)    = k_t;
                Adum(iR-1,iC)    = k_i;
    ...
    %%%%%%%%%%%%%%%%%%_corners of wire _%%%%%%%%%%%%%%%%%%%%
            ...
            elseif iR == 3 && iC == 1      %bottom left of wire
                cas = 7;
                Adum(iR,iC:iC+1) = [-(2*k_c+k_i) k_c];
                Adum(iR+1,iC) = k_c;
                Adum(iR-1,iC) = k_i;
            ...
            elseif iR == 5 && iC == 1      %top left of wire
                cas = 8;
                Adum(iR,iC:iC+1) = [-(2*k_c+k_i) k_c];
                Adum(iR+1,iC) = k_i;
                Adum(iR-1,iC) = k_c;
    ...
    %%%%%%%%%%%%%%%%%%_top and bottom of wire_%%%%%%%%%%%%%%%%%%%%
            ...
            elseif iR == 5 && iC < 2 %do range for top of copper
                cas = 11;
                Adum(iR,iC-1:iC+1) = [k_c -(3*k_c+k_i) k_c];
                Adum(iR+1,iC)    = k_i;
                Adum(iR-1,iC)    = k_c;
            ...
            elseif iR == 3 && iC < 2    %do range for bottom of copper
                cas = 12;
                Adum(iR,iC-1:iC+1) = [k_c -(3*k_c+k_i) k_c];
                Adum(iR+1,iC)    = k_c;
                Adum(iR-1,iC)    = k_i;
    ...
    %%%%%%%%%%%%%%%%%%_top of model_%%%%%%%%%%%%%%%%%%%%
            ...
            elseif iR == 20 && iC > 0   %do range for top of t exposed to air
                cas = 13;
                Adum(iR,iC:iC+1) = [-(2+Bi) .5]; %Adum(iR,iC-1:iC+1) = [.5 -(2+Bi) .5];
                Adum(iR-1,iC)    = 1;
                b(iN) = -T_air*Bi; %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%%%%%%%%%%%%%%_interior cells_%%%%%%%%%%%%%%%%%%%%
            ...
            elseif iR > 3 && iR < 5 && iC < 2 && iC > 1 %range for all interior wire cells 
                cas = 14;
                Adum(iR,iC-1:iC+1) = [1 -(4) 1];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
            ...
            elseif  iR > 9 && iC > 1 && iC < 17 %range for all interior tile cells 
                cas = 16;
                Adum(iR,iC-1:iC+1) = [1 -(4) 1];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
    ...
    % %%%%%%%%%%%%%%%%%%_bottom of insulation_%%%%%%%%%%%%%%%%%%%%
        ...
        %%%%%%  breaks it ???????????  %%%%%%%%%%%%%%%%%%
            ...
            elseif iR < 2 && iC > 1 && iC < 17 %do range for all bottom of the insulation            
                cas = 17;
                Adum(iR,iC-1:iC+1)  = [1 -(3) 1];
                Adum(iR+1,iC)       = 1;
    ...
    %%%%%%%%%%%%%%%%%%%%%_left walls_%%%%%%%%%%%%%%%%%%%%%%%
            ...
            elseif (iR > 1 && iR < 3 && iC < 2) | (iR > 5 && iR < 10 && iC < 2)  %do range for all left walls of insulation
                cas = 18;
                Adum(iR,iC:iC+1) = [-3 1];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
            ...
            elseif iR > 9 && iR < 20 && iC < 2%do range for all left walls of tile
                cas = 19;
                Adum(iR,iC:iC+1) = [-3 1];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
            ...
            elseif iR > 3 && iR < 5 && iC < 2%do range for all left walls of copper
                cas = 20;
                Adum(iR,iC:iC+1) = [-3 1];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
    ...
    %%%%%%%%%%%%%%%%%%%%%_right walls_%%%%%%%%%%%%%%%%%%%%%%%
    % 
            elseif iR > 1 && iR < 10 && iC > 16 %do range for all right walls of insulation
                cas = 21;
                Adum(iR,iC-1:iC) = [1 -3];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
            ...
            elseif iR > 9 && iR < 10 && iC > 16%do range for all right walls of tile
                cas = 22;
                Adum(iR,iC-1:iC) = [1 -3];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
            ...
            elseif iR < 5 && iR > 3 && iC == 2 %do range for all right walls of copper
                cas = 23;
                Adum(iR,iC-1:iC) = [1 -3];
                Adum(iR+1,iC)    = 1;
                Adum(iR-1,iC)    = 1;
