...
k_c       = 1;     %thermal conductivity of copper wire
k_i       = 1;     %thermal conductivity of insulation
k_t       = 1;     %thermal conductivity of tile
k_air     = 1;
...
%                      right and left side                        %
        ...
        elseif iR == 1 && iC > 0 %do range for bottom of tile
            cas = 24;
...
%%%%%%%%%%%%%%%%%%_interior cells_%%%%%%%%%%%%%%%%%%%%
        ...
        elseif iR > 10 && iR < 20 && iC < 6 && iC > 1%range for all interior tile cells 
            cas = 16;
            Adum(iR,iC-1:iC+1) = [1 -(3) 1];
            Adum(iR+1,iC)    = 1;
            Adum(iR-1,iC)    = 1;
...
%%%%%%%%%%%%%%%%%%_bottom of insulation_%%%%%%%%%%%%%%%%%%%%
        ...
        elseif %do range for all bottom of the insulation            
            cas = 17;
...
%%%%%%%%%%%%%%%%%%%%%_left walls_%%%%%%%%%%%%%%%%%%%%%%%
        ...
        elseif %do range for all left walls of insulation
            cas = 18;
        ...
        elseif %do range for all left walls of tile
            cas = 19;
        ...
        elseif %do range for all left walls of copper
            cas = 20;
...
%%%%%%%%%%%%%%%%%%%%%_right walls_%%%%%%%%%%%%%%%%%%%%%%%
        ...
        elseif %do range for all right walls of insulation
            cas = 21;
        ...
        elseif %do range for all right walls of tile
            cas = 22;
        ...
        elseif %do range for all right walls of copper
            cas = 23;
